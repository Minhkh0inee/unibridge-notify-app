...
export default function AppTabs() {
  ...
  return (
    <Tabs
      ...
      <Tabs.Screen name="explore" options={{ title: visibleTabs.explore.label }} />
      <Tabs.Screen name="insights" options={{ title: visibleTabs.insights.label }} />
...
function FloatingTabBar({ state, descriptors, navigation }: TabBarProps) {
  ...
  return (
    <View pointerEvents="box-none" style={[styles.barWrap, { paddingBottom: Math.max(insets.bottom, 16) }]}>
      <View
        style={[
          styles.bar,
          {
...
function TabItem({
  ...
  return (
    <Pressable
      accessibilityLabel={descriptor.options.tabBarAccessibilityLabel ?? item.label}
      onPress={onPress}
